...
| Schema assertions (`db:verify`)        | **173**, up from 162                                                                                               |
...
| Migrations applied  | 🟢 **all 21**, local and remote in lockstep                                    |
...
| #    | Issue                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Severity                                                                                                                               | Plan                                                                                                                                                           |
| ---- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| K-24 | **`redirectTo` is double-prefixed with the locale after sign-in.** Middleware writes `redirectTo=/uz/admin/categories` — already locale-prefixed — and the post-sign-in redirect goes through `@/i18n/navigation`, which prefixes it again. Observed in the network log as `GET /uz/uz/admin/categories`. Found while signing in to verify the category admin; **not fixed here**, because it belongs to the auth flow and this change touched none of it. The visitor lands on a 404 instead of the page they asked for, which is every protected route reached while signed out.                                                                                                                                                                        | **Medium — it breaks the redirect for every protected route**, and it is silent: sign-in succeeds, so it reads as "the link is broken" | Strip the locale prefix before handing `redirectTo` to the localized router, or store it unprefixed in the first place                                         |
...
| -------------- | ------------ | -------------------------------------- | --------------------------------------------------------------------- |
| **Brands**     | ✅           | ✅ live                                | none                                                                  |
| **Categories** | ✅           | ✅ live, 36/36                         | none — tree, drag & drop, icons, images, SEO all persist              |
...
| Layer                      | Evidence                                                                                                         |
| -------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `npm run verify`           | passes — **173 schema assertions** (up from 162) + production build                                              |
| Migration on the project   | `supabase db push` applied it to `pgxqnezwrwfgrmamlxhs`; **21 migrations** local and remote in lockstep          |
