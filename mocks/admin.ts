...
export const adminRoles: AdminRole[] = [
  {
    ...
    description: {
      uz: "Barcha bo'limlarga to'liq kirish huquqi.",
      ru: "Полный доступ ко всем разделам.",
      en: "Full access to every section.",
    },
    isSystem: true,
    memberCount: 1,
  },
...
export const banners: Banner[] = [
  {
    id: "b1",
    title: {
      uz: "Tayyor o'yin kompyuterlari",
      ru: "Готовые игровые компьютеры",
      en: "Prebuilt gaming computers",
    },
    subtitle: {
      uz: "Har biri 24 soat sinovdan o'tadi. 3 yil kafolat.",
      ru: "Каждый проходит 24 часа тестов. Гарантия 3 года.",
      en: "Each one runs 24 hours of testing. Three-year warranty.",
    },
    ctaLabel: {
...
export const homepageSections: HomepageSection[] = [
  ...
  },
  {
    ...
    type: "featured",
    title: {
      uz: "Ko'p sotilayotgan mahsulotlar",
      ru: "Хиты продаж",
      en: "Best sellers",
    },
    subtitle: {
...
export const contentPages: ContentPage[] = [
  {
    ...
    body: {
      uz: "Bondo — Toshkentdagi kompyuter do'koni. Sotadigan kompyuterlarimizni o'zimiz yig'amiz va jo'natishdan oldin sinovdan o'tkazamiz.",
      ru: "Bondo — магазин компьютерной техники в Ташкенте. Компьютеры собираем сами и тестируем перед отправкой.",
      en: "Bondo is a computer store in Tashkent. We build the computers we sell and test them before they ship.",
    },
    seo: EMPTY_SEO,
    isPublished: false,
  ...
  },
  {
    ...
    body: {
      uz: "O'zimiz yig'gan har bir kompyuterga 3 yil kafolat beriladi. Alohida sotiladigan qismlarga ishlab chiqaruvchi kafolati amal qiladi.",
      ru: "На каждый собранный нами компьютер даётся гарантия 3 года. На отдельные комплектующие действует гарантия производителя.",
      en: "Every computer we build comes with a three-year warranty. Parts sold separately carry the manufacturer's warranty.",
    },
    seo: EMPTY_SEO,
    isPublished: false,
...
export const storeSettings: StoreSettings = {
  store: {
    name: "Bondo",
    tagline: {
      uz: "Noutbuk, kompyuter va butlovchi qismlar.",
      ru: "Ноутбуки, компьютеры и комплектующие.",
      en: "Laptops, computers and PC parts.",
    },
